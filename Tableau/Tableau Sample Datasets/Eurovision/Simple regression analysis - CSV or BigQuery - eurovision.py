...
independent = 'Song.Quality'
dependent = 'Place'
data_source = 'eurovision_1998 to 2012.csv' # Full path to a CSV file or a BigQuery table full name, e.g. 'bigquery-public-data.imdb.title_ratings'
sql_query = (
...
if '.csv' in data_source:
    data = []
    with open(data_source, encoding="latin-1") as file:
