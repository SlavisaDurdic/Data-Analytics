...
sql_table = 'college_donation' # Enter a name of the MySQL table, e.g. 'bigquery_imdb_title_basics'
data_source = 'advancement_donations_and_giving_demo - scholarship.csv' # Full path to a file or a BigQuery table name
...
try:
    conn = mysql.connect(host='localhost', database='<database_name>', user='<username>', password='<password>')
