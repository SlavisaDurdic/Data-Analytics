...
# > if 2 samples in hypothesis testing: 15-25, 125-129 AND 135
...
if data_source_2 == 'Enter a data source':
    ...
    print(f"Data download and data cleansing took about {source_download - start} seconds...")
    print(
        f'There is {len(x_1_values)} and {len(x_2_values)} of data points in each sample, '
        f'and number of NULL values in data sources equals to {null_values_1} and {null_values_2}, respectively...')
    ...
    else: print(f'At least one of n*p or n*q ({x_1_size*population_1_p, x_1_size*(1-population_1_p),x_2_size*population_2_p, x_2_size*(1-population_2_p)}) is less than 5, therefore this is not the case with large samples...')
