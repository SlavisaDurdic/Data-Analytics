...
sample_variable = 'Enter your variable name'
query_source_1 = 'Enter the source table' # A BigQuery table full name, e.g. 'bigquery-public-data.imdb.title_ratings'
...
# OPTIONAL: Plot a histogram to visualize and confirm if the sample fallows a normal distribution
plt.hist(x)
plt.show()