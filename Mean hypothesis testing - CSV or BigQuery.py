...
# > if 2 samples in hypothesis testing: 17-27, 180-186 AND 192
...
if data_source_2 == 'Enter a data source':
    ...
    if are_samples_independent is True:  # Independent samples
        print("The two samples are independent...")
        if population_source_1_stDev != [] and population_source_2_stDev != []:  # σ1 and σ2 are known
            print(f"Population standard deviations are known and sample sizes are {x_1_size} and {x_2_size}. Furthermore, if:\n"
            ...
            st_dev_x_1_2 = ((population_source_1_stDev[0] ** 2) / x_1_size + (population_source_2_stDev[0] ** 2) / x_2_size) ** 0.5
            ...
            if are_population_variances_equal is True:  # σ1 and σ2 are equal, although NOT known
                print(f"Population standard deviations are unknown and assumed being equal, and sample sizes are {x_1_size} and {x_2_size}. Furthermore, if:\n"
                      "- sample size is less than 30, but it is normally distributed, or\n"
                      "- sample size is 30 or more\n"
                      "--> We use Student t test.")

                # Weighted standard deviation
                Sp = (((x_1_size - 1) * (x_1_stDev ** 2) + (x_2_size - 1) * (x_2_stDev ** 2)) / (x_1_size + x_2_size - 2)) ** 0.5
