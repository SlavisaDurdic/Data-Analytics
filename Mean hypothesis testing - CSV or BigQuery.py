...
# > if 2 samples in hypothesis testing: 17-27, 166-172 AND 178
...
if data_source_2 == 'Enter a data source':
    ...
    print(f'There is {len(x_values)} of observed data in total, and number of NULL values in the data source equals to {null_values}...')
