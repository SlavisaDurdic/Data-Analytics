...
I have built scorecards, pie, map, and line charts. Overall, the visuals show funding during 1990-2014 into venture capital companies by year, market, company name, and geo location.
In order to better analyze data, I've added filters and also configured all visuals (except scorecards) to act as filters.
